...
public final class DBContract {
    ...
    static abstract class Articles {
        ...
        static final String ACCOUNT_KEY = "col_11";
        static final String SOURCE_KEY = "col_12";
        static final String WRITER_NAME = "col_13";
        static final String SOURCE_NAME = "col_14";
        static final String HEADLINE = "col_6";
        static final String STORY = "col_7";
        static final String TAGS = "col_8";
        static final String IMAGE_LINK = "col_9";
        static final String SOURCE_LINK = "col_5";
        static final String TIMESTAMP = "local_uid";
        static final String ORIGINAL_TIMESTAMP = "col_10";
        static final String IS_FAVORITE = "col_15";
        static final String IS_AVAILABLE = "col_16";
        ...
        static final String ACCOUNT_LINK = "col_4";
    }
